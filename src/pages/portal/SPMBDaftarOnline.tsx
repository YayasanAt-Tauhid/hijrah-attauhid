...
export default function SPMBDaftarOnline() {
  ...
  const akhwatNonAsrama = ["SMP", "SMA"].includes(selectedDeptCode) && form.jenis_kelamin === "P";
  ...
  async function submit(e: React.FormEvent) {
    ...
    if (wajibAsrama && !form.status_asrama) {
      toast.error("Pilihan Asrama / Non Asrama wajib dipilih untuk SMP dan SMA Ikhwan");
      return;
    }
              ...
              <FormSection title="Data Diri Murid" description="Informasi pendaftaran dan identitas calon murid">
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  {mtaWajibAsrama
                    ...
                    : akhwatNonAsrama
                      ? <div><Label>Status Asrama *</Label><Input value="NON ASRAMA — khusus Akhwat SMP/SMA" disabled /></div>
                  ...
                  <div><Label>Jenis Kelamin *</Label><OptionSelect value={form.jenis_kelamin} placeholder="Pilih jenis kelamin" options={[["L", "LAKI-LAKI"], ["P", "PEREMPUAN"]]} onValueChange={(v) => setForm((f) => ({ ...f, jenis_kelamin: v, status_asrama: "" }))} /></div>
